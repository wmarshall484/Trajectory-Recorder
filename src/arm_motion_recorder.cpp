#include <trajectory_recorder/arm_motion_recorder.h>

ArmMotionRecorder::ArmMotionRecorder(std::string arm_name) : arm_name_(arm_name), node_handle_("~")
{
...
void ArmMotionRecorder::joyCallback(const sensor_msgs::JoyConstPtr &joy)
{
...
void ArmMotionRecorder::leftArmControllerCallback(const pr2_controllers_msgs::JointTrajectoryControllerStateConstPtr &state)
{
  ...
  {
    ROS_DEBUG("recording joint positions");
